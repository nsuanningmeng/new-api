...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.Distribute(), middleware.PriceResolver())
	{
	...
	relayV1Router.Use(middleware.ModelRequestRateLimit())
	{
		...
		wsRouter.Use(middleware.Distribute(), middleware.PriceResolver())
	...
	}
	{
		...
		httpRouter.Use(middleware.Distribute(), middleware.PriceResolver())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.Distribute(), middleware.PriceResolver())
	{
	...
	relayGeminiRouter.Use(middleware.Distribute(), middleware.PriceResolver())
	{
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.Distribute(), middleware.PriceResolver())
	{
